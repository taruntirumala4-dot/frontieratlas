...
import { getAuthorBySlug, type AuthorDetail } from "@/lib/authors";
import AuthorDetailComponent from "@/components/AuthorDetail";
    ...
    <div className="ds-card-hero p-6 md:p-8 mb-8 animate-pulse">
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
        <div className="flex items-center gap-4 flex-1">
          <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#E5E5E0] shrink-0" />
      ...
      <div className="min-h-screen bg-[#F8F7F2] text-[#111111]">
        <div className="w-full max-w-[1200px] mx-auto px-4 md:px-8 xl:px-12 py-8">
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-3">
            ...
            <button onClick={fetchAuthor} className="ds-button text-[12px]">
              Retry
            </button>
            <Link
              href="/authors"
